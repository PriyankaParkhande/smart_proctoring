...
app = Flask(__name__)
# app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:root@localhost/my_database"
db = SQLAlchemy(app)
...
app.config['MAIL_USERNAME'] = 'vrap2k22@gmail.com'
app.config['MAIL_PASSWORD'] = 'Vrap@2000'
...
def register():
	if request.method == 'POST':
		...
		global tempName,tempEmail,tempPassword,tempUT,tempImage
		tempName=name
		tempEmail=email
...
def login():
	if request.method == 'POST':
		...
		# 	# 	print(results2)
		# 	# 	if results2 > 0:
		# 	# 			print(email," ",name," ",user_type," ",uid)
...
def verifyEmail():
	if request.method == 'POST':
		...
		print('The otp from form ',theOTP)
